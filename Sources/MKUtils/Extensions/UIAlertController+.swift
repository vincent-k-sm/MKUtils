...
public extension UIAlertController {
    ...
    */
    static func commonDebugAlert(title: String = "DEBUG Error", errorMsg: String, confirmHandler: AlertActionHandler? = nil) {
    ...
    static func showMessage(_ message: String, confirmTitle: String = "확인") {
    ...
    */
    ...
    static func showAlertFullSize(title: String?, message: String?, actions: [UIAlertAction], style: UIAlertController.Style = .alert) {
        DispatchQueue.main.async {
            let alert = UIAlertController(title: title, message: message, preferredStyle: style)
