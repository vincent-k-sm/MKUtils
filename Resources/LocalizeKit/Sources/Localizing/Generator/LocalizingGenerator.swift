...
//        + " && '\(self.scriptPath)' \(arguments.joined(separator: " "))"
        ...
        if
            [ "$variableName" != "" ]
        then
            echo "    static let $variableName = \\"$variableName\\".localized" >> I18N.swift
        fi
        ...
        echo "extension String {" >> I18N.swift
        echo "    var localized: String {" >> I18N.swift
        echo "        return NSLocalizedString(self, comment: \\"\\")" >> I18N.swift
        echo "    }" >> I18N.swift
        echo "}" >> I18N.swift
        """
